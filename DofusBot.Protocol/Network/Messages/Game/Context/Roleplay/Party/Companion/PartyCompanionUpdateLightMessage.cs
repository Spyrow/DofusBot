...
namespace DofusBot.Protocol.Network.Messages.Game.Context.Roleplay.Party.Companion
{
    using DofusBot.Protocol.Network.Messages.Game.Context.Roleplay.Party;
